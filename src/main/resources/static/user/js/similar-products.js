...
class SimilarProductsManager {
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="quantity-selector mb-4">
                                        ...
                                        <div id="quickViewQuantityError_${product.productId}" class="text-danger mt-2" style="display: none;">
                                            ...
                                            <span id="quickViewQuantityErrorMessage_${product.productId}">Số lượng tối đa bạn có thể mua là ${product.stock || 10}.</span>
                                        </div>
                                    </div>
    ...
    validateQuantity(productId) {
        ...
        if (currentValue < 1) {
            ...
            errorDiv.style.display = 'block';
            errorMessage.textContent = `Số lượng không thể vượt quá ${maxStock}.`;
            quantityInput.classList.add('is-invalid');
        } else {
            errorDiv.style.display = 'none';
            quantityInput.classList.remove('is-invalid');
